...
public class EventEngineManager
{
	...
	/**
	 * Disminu�mos la cantidad de votos
	 * @param player -> personaje q esta votando
	 * @return
	 */
	public void removeVote(L2PcInstance player)
	{
		...
		{
			// Si estaba en la lista, empieza a buscar para qu� evento vot�
			for (Class<? extends AbstractEvent> event : _currentEventVotes.keySet())
			{
	 ...
	 * entre los que m�s votos tienen<br>
	 * @return
	 */
	...
	/**
	 * Obtenemos la colecci�n de jugadores registrados
	...
	/**
	 * Limpia la colecci�n de jugadores
	 * @return
	 */
	 ...
	 * @return <li>True - > Est� registrado.</li><br>
	 *         <li>False - > No est� registrado.</li><br>
	 */
